...
public class ArticleApiTest {
    ...
    @Test
    void readTest(){
        ArticleResponse response = read(182900956223025152L);
        System.out.println("response = " + response);
    }
    ...
    void update(Long articleId) {
        restClient.put()
                .uri("/v1/articles/{articleId}", articleId)
                .body(new ArticleUpdateRequest("hi 2", "content 22"))
                .retrieve();
    }
    ...
    void deleteTest(){
        restClient.delete()
                .uri("/v1/articles/{articleId}", 182900956223025152L)
                .retrieve();
    }
