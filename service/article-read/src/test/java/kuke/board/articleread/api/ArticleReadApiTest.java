...
import kuke.board.articleread.ArticleReadApplication;
...
public class ArticleReadApiTest {
    ...
    void readAllInfiniteScrollTest() {
        List<ArticleReadResponse> response1 = articleReadRestClient.get()
                .uri("/v1/articles/infinite-scroll?boardId=%s&pageSize=%s&lastArticleId=%s".formatted(1L, 5L, 193748548875210752L))
                .retrieve()
